...
RUN apt update && apt install --no-install-recommends -y curl tar perl libnet-ssleay-perl libauthen-pam-perl expect tzdata supervisor samba jq ca-certificates && \
